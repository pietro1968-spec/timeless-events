import { a as HERO_SLIDES, c as QUOTES, i as FLOWERS, r as FEATURED_SERVICES, t as ABOUT, u as SITE } from "./site-D--YTEML.js";
import { t as ServiceCard } from "./service-card-BWvRlwnp.js";
...
function Home() {
	...
	return /* @__PURE__ */ jsxs("main", { children: [
		/* @__PURE__ */ jsxs("section", {
			...
			children: [
				HERO_SLIDES.map((src, i) => /* @__PURE__ */ jsx("img", {
					src,
					alt: "",
					className: "absolute inset-0 size-full object-cover transition-opacity duration-1000",
					style: { opacity: i === slide ? 1 : 0 }
				}, src)),
				/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-ink/50" }),
				/* @__PURE__ */ jsxs("div", {
		...
		/* @__PURE__ */ jsxs("section", {
			...
			children: [/* @__PURE__ */ jsx("div", {
				...
				/* @__PURE__ */ jsxs(Link, {
					...
					children: ["Scopri di più su di me ", /* @__PURE__ */ jsx(ArrowRight, { className: "size-3.5" })]
				})
			] })]
		}),
		...
		/* @__PURE__ */ jsxs("section", {
			...
			children: [/* @__PURE__ */ jsx("div", {
				...
				children: FEATURED_SERVICES.map((s) => /* @__PURE__ */ jsx(ServiceCard, {
					service: s,
					featured: true
				}, s.slug))
			}), /* @__PURE__ */ jsx("div", {
			...
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", { children: [
					...
					/* @__PURE__ */ jsx("ul", {
						...
						children: FLOWERS.slice(0, 6).map((f) => /* @__PURE__ */ jsxs("li", {
					...
					/* @__PURE__ */ jsxs(Link, {
						...
						params: { slug: "fiori" },
						className: "mt-8 inline-flex items-center gap-2 text-[0.72rem] font-semibold uppercase tracking-[0.2em] text-gold-deep",
						children: ["Esplora i fiori ", /* @__PURE__ */ jsx(ArrowRight, { className: "size-3.5" })]
					})
				] }), /* @__PURE__ */ jsx("div", {
					className: "overflow-hidden rounded-2xl",
					children: /* @__PURE__ */ jsx("img", {
		...
		/* @__PURE__ */ jsxs("section", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("div", {
					...
					children: QUOTES.map((q) => /* @__PURE__ */ jsxs("blockquote", {
