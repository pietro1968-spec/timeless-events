//#region node_modules/.nitro/vite/services/ssr/assets/site-D--YTEML.js
var SITE = {
...
var FEATURED_SERVICES = [
	{
		...
		excerpt: "Ricordi di gusto che raccontano storie attraverso menù raffinati, prodotti di altissima qualità e mise en place curate nei minimi dettagli.",
		body: [
	...
	},
	{
		...
		excerpt: "Selezioniamo ville d’epoca, dimore storiche e location panoramiche per regalare la cornice perfetta al tuo evento speciale.",
		body: [
	...
	},
	{
		...
		excerpt: "Consulenza d’immagine su misura e selezione di atelier per scegliere l’abito dei tuoi sogni con stile, armonia ed eleganza.",
		body: [
...
var SERVICES = [
	...FEATURED_SERVICES.filter((s) => s.slug !== "location"),
	{
		...
		body: ["Dalla scenografia floreale alla logistica, ogni momento viene orchestrato perché tu viva emozioni autentiche e senza stress.", "Allestimenti cerimonia a Milano e in tutta Italia, pensati per ambienti sacri, civili e simbolici."],
	...
	},
	{
		...
		excerpt: "I nostri floral stylist trasformano fiori e piante in opere d’arte che raccontano la vostra storia.",
		body: [
	...
	},
	{
		...
		body: ["I nostri make-up artist e hair stylist professionisti valorizzano i tuoi tratti, assicurando un make-up che resiste alle emozioni, alle foto e al ballo."],
	...
	},
	{
		...
		body: ["Accendi la festa con performance musicali su misura, per emozionare e coinvolgere i tuoi ospiti.", "La disponibilità di alcuni gruppi o artisti può variare in base alla data, alla location e alla logistica tecnica."],
	...
	},
	{
		...
		body: ["Montaggi creativi, storytelling su misura e riprese professionali per rivivere ogni attimo con emozione."],
	...
	},
	{
		...
		body: ["Dall’allestimento alla torta, ogni dettaglio è curato per creare un giorno unico, in armonia con la tua visione e lo stile del tuo evento."],
	...
	},
	{
		...
		body: ["Dal coordinato all’intrattenimento, progettiamo cerimonie ed eventi eleganti, adatti alle famiglie che cercano emozione e semplicità."],
	...
	},
	{
		...
		body: ["Progettiamo eventi tematici, allestimenti personalizzati e intrattenimento su misura per adulti e bambini, con cura su ogni dettaglio."],
	...
	},
	{
		...
		body: ["Dimentica gli schemi, le regole imposte e i soliti riti. Il vostro matrimonio non deve assomigliare a quello di nessun altro.", "Team creativi, scelte fuori dagli stereotipi, esperienza personalizzata e piena libertà espressiva."],
	...
	},
	{
		...
		body: ["Dalla prima visione al dettaglio finale, curo ogni aspetto per regalarvi un giorno senza pensieri.", "Ascolto i vostri desideri per tradurli in realtà, rispettando priorità e investimento, senza rinunciare allo stile."],
	...
	},
	{
		...
		title: "Servizi Extra",
		short: "Scopri",
		excerpt: "Animazione, dog sitter, coordinazione ospiti, wedding cake, web wedding site e molto altro.",
		body: ["Ogni richiesta diventa realtà grazie alle nostre soluzioni personalizzate."],
...
function getService(slug) {
	if (slug === "location") return FEATURED_SERVICES.find((s) => s.slug === "location");
...
var PORTFOLIO = [
	{
		...
		intro: ["Realizza il matrimonio dei tuoi sogni a Milano e in tutta Italia con Timeless Events.", "Ci occupiamo di ogni dettaglio, dall’abito alla location, per un giorno perfetto. La favola ha inizio… e questa è solo la prima pagina."],
	...
	},
	{
		...
		intro: ["Scopri le migliori location per matrimoni, eventi aziendali e cerimonie a Milano e in tutta Italia.", "Collaboriamo con ville, dimore storiche e scenari internazionali. Lago di Como, giardini sul lago, Lisbona e dimore d’epoca: scegliamo l’ambientazione e la gestiamo in modo impeccabile."],
	...
	},
	{
		...
		intro: ["Organizza eventi aziendali a Milano e in tutta Italia con Timeless Events.", "Dalle conferenze agli eventi di team building, rendiamo ogni occasione unica e professionale. Ogni tavolo è una tela bianca, pronta ad accogliere il cuore dell’evento."],
...
//#endregion
export { HERO_SLIDES as a, QUOTES as c, TRENDS_2026 as d, getAlbum as f, FLOWERS as i, SERVICES as l, FAQS as n, NAV as o, getService as p, FEATURED_SERVICES as r, PORTFOLIO as s, ABOUT as t, SITE as u };
