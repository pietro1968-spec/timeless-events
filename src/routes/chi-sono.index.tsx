    ...
    <main>
      <section className="relative overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-6 py-24 text-center text-ivory sm:py-32">
          ...
          <h1 className="mt-4 font-display text-4xl leading-tight text-ivory drop-shadow-[0_2px_10px_rgba(0,0,0,0.45)] sm:text-5xl">
            {ABOUT.headline}
          </h1>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-3xl px-5 py-20 text-center lg:px-8">
        ...
        <p className="mt-4 text-sm leading-relaxed text-muted">
          Se desideri pianificare un matrimonio o un evento unico e
          indimenticabile, scrivimi oggi. Sono qui per rendere i tuoi sogni
          realtÃ .
        </p>
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-3">
          ...
          <Link
            to="/chi-sono/faq"
            className="rounded-full border border-ink px-7 py-3 text-[0.72rem] font-semibold uppercase tracking-[0.16em] text-ink"
          >
            Leggi le FAQ
          </Link>
        </div>
