    ...
    <main>
      <section className="relative h-[88vh] min-h-[560px] overflow-hidden text-ivory">
        ...
        <div className="relative z-10 mx-auto flex h-full max-w-4xl flex-col items-center justify-center px-6 text-center">
          <p className="text-[0.72rem] font-medium uppercase tracking-[0.4em] text-gold">
            Wedding Planner
          </p>

          <h1 className="mt-4 font-display text-5xl leading-tight text-ivory drop-shadow-[0_2px_10px_rgba(0,0,0,0.45)] sm:text-6xl lg:text-7xl">
            Timeless Events
          </h1>
          ...
          <p className="mt-6 max-w-xl text-base font-light leading-relaxed text-ivory/90 sm:text-lg">
            Trasformiamo i vostri sogni in realtà senza tempo, curando ogni
            dettaglio con l&apos;eleganza che meritate.
          </p>
      ...
      <section className="bg-olive py-10 text-center text-ivory">
        <p className="mx-auto max-w-3xl px-6 font-display text-xl italic sm:text-2xl">
          Ogni evento è unico e indimenticabile. Esplora le nostre aree di
          specializzazione.
        </p>
      </section>
      ...
      <section className="bg-cream py-20">
        <div className="mx-auto grid max-w-6xl items-center gap-12 px-5 lg:grid-cols-2 lg:px-8">
          <div>
            ...
            <p className="mt-4 text-sm leading-relaxed text-muted">
              Scopri la nostra collezione floreale: ogni fiore racconta una
              storia di bellezza, simbolo e significato. I fiori trasformano
              l&apos;atmosfera, parlano al cuore e rendono ogni momento unico.
            </p>
      ...
      <section className="bg-cream/50 py-20">
        <div className="mx-auto max-w-7xl px-5 text-center lg:px-8">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-sm text-muted">
            Dalla prima visione al dettaglio finale, curo ogni aspetto per
            regalarvi un giorno senza pensieri.
          </p>
            ...
            {QUOTES.map((q, idx) => (
              ...
              >
                ...
                <footer className="mt-6 border-t border-line/60 pt-4">
                  ...
                  {q.event && (
                    <p className="mt-0.5 text-[0.68rem] font-light text-muted">
                      {q.event}
                    </p>
                  )}
                </footer>
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full border border-gold/80 bg-paper px-6 py-2.5 text-[0.7rem] font-semibold uppercase tracking-[0.18em] text-ink shadow-sm transition-colors hover:bg-gold hover:text-ink"
            >
          ...
          <div className="mt-16 border-t border-line/60 pt-12">
            <p className="font-display text-2xl sm:text-3xl">
              Sei pronto/a a fare il grande passo?
            </p>

            <p className="mx-auto mt-2 max-w-xl text-sm text-muted">
              Ascolto i vostri desideri per tradurli in realtà. Insieme
              costruiremo l&apos;atmosfera magica che avete sempre immaginato.
            </p>

            <Link
              to="/preventivo"
              className="mt-6 inline-flex rounded-full bg-ink px-8 py-3 text-[0.72rem] font-semibold uppercase tracking-[0.18em] text-ivory transition-colors hover:bg-gold hover:text-ink"
            >
              Inizia da qui
            </Link>
          </div>
